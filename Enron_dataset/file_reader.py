...
class File_reader(object):
  def __init__(self):
    self.ham = []
    self.spam = []
    self.ham_paths = ["Enron_dataset/enron1/ham/*.txt", "Enron_dataset/enron2/ham/*.txt", "Enron_dataset/enron3/ham/*.txt", "Enron_dataset/enron4/ham/*.txt", "Enron_dataset/enron5/ham/*.txt", "Enron_dataset/enron6/ham/*.txt"]
    self.spam_paths = ["Enron_dataset/enron1/spam/*.txt", "Enron_dataset/enron2/spam/*.txt", "Enron_dataset/enron3/spam/*.txt", "Enron_dataset/enron4/spam/*.txt", "Enron_dataset/enron5/spam/*.txt", "Enron_dataset/enron6/spam/*.txt"]
